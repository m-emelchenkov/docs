...
The Agno SDK gives you three primitives. Agents for autonomy, teams for coordination, workflows for deterministic control. Same SDK, composable for your use case.
...
- **Platform-ready on day one.** Sessions, memory, knowledge, tracing, evals, and human-in-the-loop come built in. The same agent you prototype in a python script runs on your [agent platform](/agent-platform/overview) behind [AgentOS](/features/runtime).

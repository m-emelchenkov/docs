...
Supported on [Step](/workflows/hitl/step), [Router](/workflows/hitl/router#output-review), and [Loop](/workflows/hitl/loop#iteration-review) (via `requires_iteration_review`).
...
| `hitl_timeout` | `int` | `None` | Seconds before auto-resolving. See [Timeout](/workflows/hitl/timeout) |

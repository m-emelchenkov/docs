...
Agno supports these human-in-the-loop flows:
...
5. **[Approval](/hitl/approval)**: Store approval records in the DB and pause the run until an admin approves or rejects; optional audit-only mode logs resolution without pausing
...
- [HITL usage examples](/hitl/usage/)

...
| `workflow_id` | text | Runs, Sessions |
| `created_at` | datetime | Runs, Sessions |
| `start_time` | datetime | Runs, Sessions |
| `end_time` | datetime | Runs, Sessions |
| `duration_ms` | number | Runs, Sessions |

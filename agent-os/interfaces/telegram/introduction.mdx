...
Requires a bot token from [@BotFather](https://t.me/BotFather) and a webhook URL.
...
See the [full setup guide](/agent-os/interfaces/telegram/setup) for step-by-step instructions.

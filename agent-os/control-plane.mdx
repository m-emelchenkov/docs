...
Open [os.agno.com/schedules](https://os.agno.com/schedules) to view the scheduler UI in the Control Panel. For setup and API details, see [AgentOS Schedules](/agent-os/scheduler/overview) documentation.

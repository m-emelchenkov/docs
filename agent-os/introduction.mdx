...
**AgentOS is the FastAPI runtime for your agent platform.** It serves agents, teams, and workflows over HTTP and SSE, with tracing, scheduling, RBAC, and audit trails built-in. Sessions, memory, knowledge, and traces are stored in your database.

...
See [Asymmetric RBAC](/examples/agent-os/rbac/asymmetric/basic) for a complete runnable example with keypair generation and signed token output.
...
<CardGroup cols={2}>
  <Card
    title="Basic RBAC (HS256)"
    icon="lock"
    href="/agent-os/usage/rbac/basic"
  >
    Enable RBAC with a shared-secret JWT
  </Card>
  <Card
    title="Asymmetric RBAC (RS256)"
    icon="key"
    href="/examples/agent-os/rbac/asymmetric/basic"
  >

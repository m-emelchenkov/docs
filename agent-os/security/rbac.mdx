...
<Note>
The control plane only issues **RS256** keys, which is also the default. See [authorization troubleshooting](/faq/rbac-auth-failed#other-authorization-failures) for common setup issues.
</Note>

...
description: "Ship Blank Canvas to Railway with one script."
---

Blank Canvas ships one Railway script. It provisions Postgres, the app service, and a public domain. Any Docker-capable host works, but Railway is the fast path.

## Prerequisites

- A Blank Canvas repo set up locally ([setup](/tutorials/blank-canvas/setup))
...
[Next Steps →](/tutorials/blank-canvas/next-steps)
  ...
  <Tab title="Manual">
    <Steps>
      ...
      <Step title="Configure API keys">
        ...
        Full setup: [GITHUB_ACCESS.md](https://github.com/agno-agi/coda/blob/main/docs/GITHUB_ACCESS.md). Use a Fine-grained token. Classic PATs lack the scoping Coda relies on.
      </Step>

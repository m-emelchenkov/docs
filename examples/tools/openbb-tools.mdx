---
title: "OpenBB"
description: "Use OpenBB with Agno agents."
---

Enable Agno agents to pull professional-grade market data, economic indicators, and company financials directly into its reasoning loop through OpenBB integration.
...
```
For details, see [OpenBB cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/openbb_tools.py).
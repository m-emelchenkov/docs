...
description: "Use Python Function as a tool with Agno agents."
---
...
```
For details, see [Python Functions as Tools cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/python_function_as_tools.py).
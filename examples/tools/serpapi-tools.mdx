---
title: "SERP API"
description: "Use SERP API with Agno agents."
---
...
```
For details, see [Serp API cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/serpapi_tools.py).
...
description: "Use Pre and Post Hooks in Agno agents."
---

Enable granular control in Agno agents as they interact with external tools and APIs. Intercept tool execution before and after calls to log data or modify results.
...
```
For details, see [Agent Execution Hooks cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/tool_hooks/pre_and_post_hooks.py).
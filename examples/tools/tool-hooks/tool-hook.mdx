...
Use tool execution hook with async functions to run logic before and after a tool is called by Agno agents.
...
python tool_hook.py
```
For details, see [Custom Tool Interceptors cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/tool_hooks/tool_hook.py).
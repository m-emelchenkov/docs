...
Dynamically adjust tool behavior using the Agno agent’s internal session state. Build context-aware tools that adapt their execution based on the ongoing user conversation.
...
```
For details, see [State-aware Toolkit Hooks cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/tool_hooks/tool_hook_in_toolkit_with_state.py).
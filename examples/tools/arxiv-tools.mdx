---
title: "ArXiv"
description: "Use Arxiv tools with Agno Agents."
---

ArxivTools enables Agno agents to intelligently research academic papers. Use`enable_*` flags patterns for selective function access.
...
```
For details, see [Arxiv cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/arxiv_tools.py).
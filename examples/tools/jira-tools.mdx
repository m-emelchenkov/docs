---
title: "Jira"
description: "Use Jira with Agno agents."
---

Enable Agno agents to move beyond simple chat and into the core of software development and IT operations by programmatically reading, writing, and managing tasks, epics, and sprints by integrating with Jira.
...
```
For details, see [Jira cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/jira_tools.py).
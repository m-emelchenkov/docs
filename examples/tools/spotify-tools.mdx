---
title: "Spotify Tools"
description: "Use SpotifyTools with an Agno agent."
---
...
For details, see [SpotifyTools](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/toolkits/others/spotify_tools.py). 
...
if __name__ == "__main__":
    ...
    response = agent.run(
        "Create a Good Vibes playlist, add 5 upbeat songs by The Weekend and Coldplay in it."
    )

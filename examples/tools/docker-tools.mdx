---
title: "Docker"
description: "Use Docker with Agno agents."
---

Enable code sandbox layer in Agno agents with Docker. Integration with Docker allows an agent to go from just thinking about code to safely executing it in a controlled, isolated environment.
...
For details, see [Docker cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/docker_tools.py).
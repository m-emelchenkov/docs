---
title: "Nano Banana"
description: "Use Nano Banana tool with Agno agents."
---

Enable Agno agents to use Google's Nano Banana (Gemini 2.5 Flash Image) and Nano Banana Pro (Gemini 3 Pro Image) models for generating and edit images via natural language.

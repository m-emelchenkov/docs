---
title: "Lumalabs"
description: "Use Lumalabs tools with Agno agents."
---

Lumalabs tools enable Agno agents in generating high-quality, cinematic videos based on natural language prompts or reference images.
...
```
For details, see [Lumalabs cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/lumalabs_tools.py).
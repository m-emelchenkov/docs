---
title: "Crawl4AI"
description: "Use Crawl4AI with Agno agents."
---

Agno agents can use for web scraping and content extraction. For selective function access, it uses `enable_` flag patterns.
...
```
For details, see [Crawl4ai cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/crawl4ai_tools.py).
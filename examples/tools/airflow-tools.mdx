---
title: "Airflow Tools"
description: "Use AirflowTools with an Agno agent for managing Apache Airflow DAGs."
---

## Prerequisites
- Run `uv pip install apache-airflow` to install the dependencies

For details, see [AirFlowTools](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/airflow_tools.py).

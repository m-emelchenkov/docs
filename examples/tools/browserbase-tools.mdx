---
title: "Browserbase"
description: "Use Browserbase Tools with Agno Agents."
---
...
```
For details, see [Browserbase cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/browserbase_tools.py).
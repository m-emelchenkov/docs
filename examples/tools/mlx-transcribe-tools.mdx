...
description: "Use MLX Trascribe tool with Agno agents."
---

MLX Transcribe tool enables Agno agents to generate audio files using MLX Whisper.
...
```
For details, see [MLX Transcribe tools cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/mlx_transcribe_tools.py).
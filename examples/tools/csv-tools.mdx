---
title: "CSV"
description: "Use CSV Tools with Agno agents."
---

- Data Analysis and Processing for CSV Files

Enable Agno agents to use CSV Tools for data analysis and processing CSV files. Use `enable_` flag patterns for selective function access.
...
python csv_tools.py
```
For details, see [csv-tools cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/csv_tools.py).
---
title: "Calculator"
description: "Use Calculator with Agno Agents."
---
...
```
For details, see [Calculator cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/calculator_tools.py).
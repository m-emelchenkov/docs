...
Enable Agno agents with Duckduckgo tools to browse the live internet, retrieve real-time facts, and find external data—all while maintaining the user's anonymity.
...
```
For details, see [Duckduckgo cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/duckduckgo_tools.py).
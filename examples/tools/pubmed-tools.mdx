---
title: "PubMed"
description: "Use PubMed tools with Agno agents."
---

Enable Agno agents real-time access to the National Library of Medicine’s database, allowing them to base their responses on peer-reviewed clinical studies, systematic reviews, and experimental research through Pubmed tools.
...
```
For details, see [PubMed cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/pubmed_tools.py).
---
title: "Moviepy Video"
description: "Moviepy Video tools with Agno agents."
---

Enable Agno agents to perform complex post-production tasks—like trimming, captioning, and audio extraction—using simple natural language commands with Moviepy Video.
...
```
For details, see [Modelslab tools cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/moviepy_video_tools.py).
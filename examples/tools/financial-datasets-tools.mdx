...
description: "Use financial datasets with Agno agents"
---

Enable Agno agents with various Financial Datasets API functionalities including analyzing financial statements, stock prices, news, insider trades, and more.
...
```
For details, see [Financial Dataset Tools cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/financial_datasets_tools.py).
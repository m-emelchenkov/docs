---
title: "Custom Events"
description: "Use custom events with Agno agents."
---
...
```
For details, see [Custom Tool Events cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/custom_tool_events.py).
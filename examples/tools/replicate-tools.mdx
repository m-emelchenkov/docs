---
title: "Replicate"
description: "Use Replicate tools with Agno agents."
---

Enable Agno agents to generate high-fidelity images, videos, and other media by calling the Replicate tool's library of open-source machine learning models.
...
```
For details, see [Replicate cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/replicate_tools.py).
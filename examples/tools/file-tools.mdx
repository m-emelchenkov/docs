...
description: "Use file management with Agno agents."
---

Enable Agno agents to perform file system operations and management with File Tools. The `enable_` flag pattern is used for selective function access.

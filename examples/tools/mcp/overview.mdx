...
| [Dynamic Headers](/examples/tools/mcp/dynamic-headers) | Cookbook examples for this tools subsection. |
| [Local Server](/examples/tools/mcp/local-server) | Cookbook examples for this tools subsection. |
| [Mcp Toolbox Demo](/examples/tools/mcp/mcp-toolbox-demo) | This demo showcases how to set up and run an Agno Agent that can interact with a PostgreSQL database through the [MCP Toolbox for Databases](https://googleapis.github.io/genai-tool. |
| [Sse Transport](/examples/tools/mcp/sse-transport) | This cookbook shows how to use the `MCPTool` util with an MCP server using SSE transport. |
| [Streamable Http Transport](/examples/tools/mcp/streamable-http-transport) | This cookbook shows how to use the `MCPTool` util with an MCP server using Streamable HTTP transport. |

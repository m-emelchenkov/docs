...
| [Teams](/examples/integrations/observability/teams) | Examples for tracing multi-agent teams. |
| [Workflows](/examples/integrations/observability/workflows) | Examples for tracing Agno workflows. |

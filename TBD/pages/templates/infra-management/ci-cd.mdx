...
If you're using [Dockerhub](https://hub.docker.com/) for images, you can build and push the images throug a Github Release. This action is defined in the `.github/workflows/docker-images.yml` file.

...
For custom audit shapes (regulatory, internal SOX-style), add a post-hook that writes to your own audit table. See [Observability](/runtime/observability#audit-logs-via-post-hooks).

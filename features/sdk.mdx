...
Agno is a complete SDK for building your agent platform in pure Python. You get three primitives to build with and a large set of capabilities you can attach to each. A primitive + capabilities + configuration becomes a **component**. The building block of your platform.
...
A primitive + capabilities + configuration becomes a **component**.

Components are the building block of your agent platform. You can create components in code, through a no-code UI or via the AgentOS API. Components created in code are final. Components created via the API or no-code UI can be versioned, checkpointed and reverted as needed. The Components API lets you build, version, and operate components over HTTP.

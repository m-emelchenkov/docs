...
Agno is a Python SDK for building multi-agent systems. It comes with three primitives to build with and a large set of capabilities you can attach to each. A primitive + capabilities becomes a component. Components are the building blocks of your agent platform.

---
title: Agent API
description: "An HTTP API and MCP server for every agent, team, and workflow in your AgentOS."
---
...
Agents need to be reachable over more than one interface. You create an agent once and AgentOS exposes it over different interfaces. The same agent answers a REST call, holds a WebSocket session, responds to a Slack event, and shows up as a tool in an MCP client.

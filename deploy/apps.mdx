...
<CardGroup cols={2}>
  <Card title="Back to Templates" icon="arrow-left" href="/deploy/templates">
    Choose or change your deployment template.
  </Card>
  <Card title="Connect Interfaces" icon="arrow-right" href="/deploy/interfaces">
    Expose your agents on Slack, Discord, or MCP.
  </Card>
</CardGroup>
...
Requires a Slack App with OAuth scopes and event subscriptions. See the [full guide](/agent-os/interfaces/slack/introduction#setup) for step-by-step setup instructions.

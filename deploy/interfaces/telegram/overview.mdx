...
Requires a bot token from [@BotFather](https://t.me/BotFather) and a webhook URL. See the [setup guide](/deploy/interfaces/telegram/setup) for step-by-step instructions.

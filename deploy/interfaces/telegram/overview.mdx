...
Requires a bot token from [@BotFather](https://t.me/BotFather) and a webhook URL. See the [full guide](/agent-os/interfaces/telegram/introduction#setup) for step-by-step setup instructions.

...
- [Agno CLI](https://docs.agno.com/): `uv pip install 'agno[infra]'`
...
- [Session Manager plugin](https://docs.aws.amazon.com/systems-manager/latest/userguide/session-manager-working-with-install-plugin.html) (for ECS Exec)
...
Set `aws_az1` and `aws_az2` to match your subnet availability zones. For ECR, use `image_repo="[ACCOUNT_ID].dkr.ecr.[REGION].amazonaws.com"`.
  ...
  <Step title="Authenticate to your registry">

...
- [Building your development image](/deploy/templates/aws/reference/configure/development-app)
- [Building your production image](/deploy/templates/aws/reference/configure/production-app)

---
title: "Interfaces"
description: "Connect deployed agents to Slack, Discord, WhatsApp, Telegram, and protocols like MCP and A2A."
---
...
| [MCP](/deploy/interfaces/mcp/overview) | Claude Desktop, Cursor, IDEs | 10 min |
...
<CardGroup cols={3}>
  ...
  <Card title="MCP" icon="plug" href="/deploy/interfaces/mcp/overview">
    Tools, resources, prompts. Anthropic protocol.
  </Card>
</CardGroup>

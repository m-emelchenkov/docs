...
<CardGroup cols={2}>
  <Card title="Back to Apps" icon="arrow-left" href="/deploy/apps">
    Add more agents, teams, or workflows.
  </Card>
  <Card title="Verify Deployment" icon="circle-check" href="/deploy/verify">
    Confirm your AgentOS is running correctly.
  </Card>
</CardGroup>
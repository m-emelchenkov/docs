...
Want a head start? Check out [pre-built solutions](/deploy/templates) like Dash, Scout, and Coda with self-learning and context retrieval already wired up.
...
<CardGroup cols={3}>
  ...
  <Card title="Browse Apps" icon="grid-2" href="/deploy/apps">

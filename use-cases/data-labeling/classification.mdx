...
Classification is extraction where the schema is a closed label set. Use a `Literal` for one label, a `List[Literal]` for many.
...
| Modality | Cookbook |
|----------|----------|
| Image | [image_classification](https://github.com/agno-agi/agno/tree/main/cookbook/data_labeling/image_classification) |
| Audio | [audio_classification](https://github.com/agno-agi/agno/tree/main/cookbook/data_labeling/audio_classification) |
| Video | [video_classification](https://github.com/agno-agi/agno/tree/main/cookbook/data_labeling/video_classification) |
| Document | [document_classification](https://github.com/agno-agi/agno/tree/main/cookbook/data_labeling/document_classification) |
...
- [Text classification cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/data_labeling/text_classification)
- [Span labeling cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/data_labeling/text_span_labeling)
